...
const nuevaString = "Never give up";
...
devolverString("Nothing is Impossible")
...
function esPositivo(numero) {
  ...
  if (num > 0){
    var positive = "Es positivo";
    return positive;
  } else if (num < 0){
    var negative = "Es negativo";
    return negative;
  } else{
    return false;
  }
...
//devuelve true o false según corresponda. Seria una forma un poco menos extensiva y funcionaria de la misma manera!
